...
( function( $, server, util, debug, widget, item ) {
    ...
    widget.inputSearch = function( pId, pData, pOptions ) {
        var i, lOriginalOptionList, lJetInput$, lJetInputContainer$, lSearchButton$, lDeferred, lInitialValue,
        ...
        require([ "ojs/ojcore", "ojs/ojselectcombobox" ], function( oj ) {
                ...
                return new Promise(function ( fulfill, reject ) {
                    ...
                    if ( optionContext.term !== undefined ) {
                        ...
                        if ( lWidgetOptions.lazyLoad ) {
                            ...
                            // reg exp escaped for any characters that have special reg exp meaning and add to pattern
                            lREPattern += util.escapeRegExp( lTerm );
            ...
            lJetInputContainer$ = lJetInput$.closest( ".oj-inputsearch-choice" );
            ...
            // In JET 8.0.0, the underlying JET widget 'ojselectcombobox' seemed to introduce a new container element around the 
            // input, with class 'oj-text-field-container'. This container element is required by the logic that positions the 
            // list. To make this work, we had to add the class to the container of the JET input.
            lJetInputContainer$.addClass( "oj-text-field-container" );
