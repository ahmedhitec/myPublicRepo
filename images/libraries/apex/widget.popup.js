        ...
        _create: function() {
            ...
            dialog$.on( "popupopen", () => {
                if ( o.noOverlay ) {
                    ...
                    setTimeout( () => {
                        $( window ).on( "blur.popupTracking", e => {
                            dialog$.popup( "close" );
                        } );
                        $( "html" ).on( "mousedown.popupTracking", e => {
                            if ( !this._allowInteraction( e ) ) {
                    ...
                    dialog$.one( "popupclose", function() {
                        $( window ).off( "blur.popupTracking" );
                        $( "html" ).off( "mousedown.popupTracking" );
                    } );
                } else {
