...
(function( model, $, util, lang, nav, pd, server, storage, apexActions, apexItem, commandHistory ) {
    ...
    var C_PROCESSING = "is-processing",
        ...
        PREF_ENABLE_COMPONENT_VIEW = "ENABLE_COMPONENT_VIEW",
    ...
    pd.splitApexUrl = function( pUrl, pPrefixWithGoto, pValidHashSubstitutions ) {
        var lSuccessMsgPos, lUrl, lAnchorStart, j, m, lSubMatch, i, lClearCacheValues, lClearCacheValue,
    ...
    function toggleEditorTab( pTabId, pValue ) {
        var tabSetId  = TAB_SETS[ 1 ], // #editor_tabs
            ...
            pPrefName = pTabId === TAB_NAME_CV ? PREF_ENABLE_COMPONENT_VIEW : PREF_ENABLE_LAYOUT_VIEW;
        ...
        var addTab = function( pData ){
            ...
            if ( hasNoTab ) {
                ...
                if ( tabId === TAB_NAME_CV ) {
                    tabName = 'Component View';
                    icon    = 'icon-comp-view';
                } else {
                    tabName = 'Layout';
                    icon    = 'icon-pd-layout';  
        ...
        apexActions.add([
            ...
            },
            {
                ...
                action: function( event, focusElement ) {
                    ...
                    //
                    toggleEditorTab( TAB_NAME_CV, false );
                    toggleEditorTab( TAB_NAME_LAYOUT, true );
                    //
                    apexActions.disable( M_THREE_COLUMN );
                    apexActions.enable( M_TWO_COLUMN );
                }
            ...
            {
                name: "pd-show-component-view",
                set: function( value ) {
                    toggleEditorTab( TAB_NAME_CV, value );
                },
                get: function() {
                    return pd.getBoolPref( PREF_ENABLE_COMPONENT_VIEW, false );
                }
            },
            {
    ...
    $( function() {
        ...
        setTimeout( function() {
            ...
            $.each( [M_CREATE_PAGE, M_CREATE_COPY_PAGE, 
            ...
            // Hide Components View by default if there is no user setting (First time visit)
            if ( pd.getPreference( PREF_ENABLE_COMPONENT_VIEW ) === null ) {
                toggleEditorTab( TAB_NAME_CV, false );
                activateTab( TAB_NAME_LAYOUT );
            }
